...
Version  : 21.12.0
Release  : 38
URL      : https://download.kde.org/stable/release-service/21.12.0/src/libkdepim-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/libkdepim-21.12.0.tar.xz
...
%prep
%setup -q -n libkdepim-21.12.0
cd %{_builddir}/libkdepim-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639669145
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkdepim-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/libkdepim/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/libkdepim-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/libkdepim/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/libkdepim-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdepim/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/libkdepim-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdepim/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/libkdepim-21.12.0/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/libkdepim/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
%find_lang libkdepim
...
/usr/lib64/libKF5Libkdepim.so.5.19.0
