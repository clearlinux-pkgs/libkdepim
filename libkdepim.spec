...
Version  : 20.12.1
Release  : 30
URL      : https://download.kde.org/stable/release-service/20.12.1/src/libkdepim-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/libkdepim-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/libkdepim-20.12.1.tar.xz.sig
...
%prep
%setup -q -n libkdepim-20.12.1
cd %{_builddir}/libkdepim-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610054883
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkdepim-20.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdepim/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/libkdepim-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdepim/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libkdepim
...
/usr/lib64/libKF5Libkdepim.so.5.16.1
