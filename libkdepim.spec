...
%setup -q -n libkdepim-24.05.0
cd %{_builddir}/libkdepim-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716481345
mkdir -p clr-build
pushd clr-build
