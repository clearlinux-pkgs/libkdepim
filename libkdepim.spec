...
Version  : 24.02.2
Release  : 72
URL      : https://download.kde.org/stable/release-service/24.02.2/src/libkdepim-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/libkdepim-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/libkdepim-24.02.2.tar.xz.sig
...
%prep
%setup -q -n libkdepim-24.02.2
cd %{_builddir}/libkdepim-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712862036
mkdir -p clr-build
pushd clr-build
