...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkdepim-22.08.0.tar.xz
...
%prep
%setup -q -n libkdepim-22.08.0
cd %{_builddir}/libkdepim-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661533780
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Libkdepim.so.5.21.0
